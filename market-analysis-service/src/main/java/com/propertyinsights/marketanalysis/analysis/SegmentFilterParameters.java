...
@Parameters({
    ...
    @Parameter(
            ...
            required = false,
            description =
                    "Inclusive minimum number of bedrooms. Omit to leave this bound unrestricted.",
            schema = @Schema(type = "integer"),
            example = "2"),
    @Parameter(
            name = "max_bedrooms",
            ...
            required = false,
            description =
                    "Inclusive maximum number of bedrooms. Omit to leave this bound unrestricted.",
            schema = @Schema(type = "integer"),
            example = "4"),
    @Parameter(
            name = "min_bathrooms",
            ...
            required = false,
            description =
                    "Inclusive minimum number of bathrooms. Omit to leave this bound unrestricted.",
    ...
    @Parameter(
            ...
            required = false,
            description =
                    "Inclusive maximum number of bathrooms. Omit to leave this bound unrestricted.",
            schema = @Schema(type = "number"),
            example = "2.5"),
    @Parameter(
            name = "min_year_built",
            ...
            required = false,
            description =
                    "Inclusive minimum construction year. Omit to leave this bound unrestricted.",
            schema = @Schema(type = "integer"),
            example = "1980"),
    @Parameter(
            name = "max_year_built",
            ...
            required = false,
            description =
                    "Inclusive maximum construction year. Omit to leave this bound unrestricted.",
            schema = @Schema(type = "integer"),
            example = "2020"),
    @Parameter(
            name = "min_lot_size",
    ...
    @Parameter(
            ...
            required = false,
            description =
                    "Inclusive minimum property price. Omit to leave this bound unrestricted.",
            schema = @Schema(type = "number"),
            example = "200000"),
    @Parameter(
            name = "max_price",
            ...
            required = false,
            description =
                    "Inclusive maximum property price. Omit to leave this bound unrestricted.",
            schema = @Schema(type = "number"),
            example = "300000")
})
