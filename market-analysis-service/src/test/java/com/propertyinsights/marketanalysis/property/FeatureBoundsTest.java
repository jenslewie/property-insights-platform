...
class FeatureBoundsTest {
  ...
  void yearLimitMovesForwardAtUtcNewYear() {
    ...
    assertThatThrownBy(() -> validate(2032, before)).isInstanceOf(IllegalArgumentException.class);
    assertThatCode(() -> validate(2032, after)).doesNotThrowAnyException();
    assertThatThrownBy(() -> validate(2033, after)).isInstanceOf(IllegalArgumentException.class);
  }
